...
(function(e, t) {
    ...
    function m(t, r) {
        function m() {
            if (f && !l) while (u.length) delete o[u.pop()];
            else u = [];
            f = !1;
            l = !1
        }
    ...
    E.prototype.renderTokens = function(t, i, s, o) {
        ...
        for (var h = 0, p = t.length; h < p; ++h) {
            ...
            case "#":
                c = i.lookup(l[1]);
                if (!c) continue;
                if (n(c)) for (var d = 0, v = c.length; d < v; ++d) u += this.renderTokens(l[4], i.push(c[d]), s, o);
